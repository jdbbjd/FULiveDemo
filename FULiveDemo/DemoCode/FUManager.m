...
//    frameSize = CGSizeMake(width, height);
    ...
    size_t w = CVPixelBufferGetBytesPerRow(pixelBuffer) / 4;
    void *img = CVPixelBufferGetBaseAddress(pixelBuffer);
    [FURenderer trackFace:FU_FORMAT_BGRA_BUFFER inputData:img width:(int)w height:(int)h];
